...
class LineLoginController extends Controller
{
    ...
    public function lineLogin()
    {
        ...
        $client_id = "&client_id=1655661701";
        $redirect_uri ="&redirect_uri=http://127.0.0.1:8000/auth/line/callback";
    ...
    public function getAccessToken($req)
    {
      ...
      $post_data = array(
        ...
        'code'          => $req['code'],
        'redirect_uri'  => 'http://127.0.0.1:8000/auth/line/callback',
        'client_id'     => '1655661701',
        'client_secret' => '677259707d65fce2bc6a61625c4a8800'
      );
