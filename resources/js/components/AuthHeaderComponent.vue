      ...
      <v-row justify="center">
        <v-list class="mt-8 font-weight-bold">
         <v-list-item link :href="'/userDetail/' + auth_user.id">
            <v-list-item-content>
              <v-list-item-title><span class="icon_area"><v-icon class="mr-2">fas fa-user-alt</v-icon></span>マイページ</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link href="/recipeList">
            <v-list-item-content>
              <v-list-item-title><span class="icon_area"><v-icon class="mr-2">fas fa-list</v-icon></span>レシピ一覧</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link href="/addRecipe">
            <v-list-item-content>
              <v-list-item-title><span class="icon_area"><v-icon class="mr-2">fas fa-plus</v-icon></span>レシピ追加</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link href="/profileEdit">
            <v-list-item-content>
              <v-list-item-title><span class="icon_area"><v-icon class="mr-2">fas fa-user-cog</v-icon></span>プロフィール編集</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link href="/passwordEdit">
            <v-list-item-content>
              <v-list-item-title><span class="icon_area"><v-icon class="mr-2">fas fa-key</v-icon></span>パスワード変更</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
      ...
      <div class="hidden-md-and-down">
        <v-list class="pc-header-list d-flex" :color="defaultCSS.backgroundColor">
         <v-list-item link :href="'/userDetail/' + auth_user.id">
          ...
          <v-list-item link href="/addRecipe">
            <v-list-item-content>
              <v-list-item-title>レシピ追加</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item link href="/profileEdit">
            <v-list-item-content>
